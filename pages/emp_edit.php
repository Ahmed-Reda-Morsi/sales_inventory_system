...
$opt .= "</select>";
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <form role="form" method="post" action="emp_edit1.php">
              ...
              <form role="form" method="post" action="emp_del.php?action=delete">
             <input type="hidden" name="role" value="<?php echo $jobb; ?>" />

                <input type="hidden" name="id" value="<?php echo $zz; ?>" />
              <button type="submit" class="btn btn-danger btn-block"><i class="fa fa-edit fa-fw"></i>Delete</button> 
              </form>  
            </div>
          </div></center>
